...
function GetClientTimestampByServerTimestamp(ServerTimestamp)
  local ServerTimeZone = DataMgr.GetServerTimeZone()
  local TimeOffsetSeconds = UE.URGBlueprintLibrary.GetTimeOffsetByTimeZoneId(ServerTimeZone)
  local ClientOffset = GetCurrentTimestamp(false) - GetCurrentTimestamp(true)
  return ServerTimestamp - TimeOffsetSeconds + ClientOffset
end
