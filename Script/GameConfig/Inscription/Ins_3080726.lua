local Ins_3080726 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconPurview/Frames/Wasteland_Ordinary_Passive_06.Wasteland_Ordinary_Passive_06",
	InscriptionDataAry = 
	{
		{
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Atlas_DT/IconPurview/Frames/Wasteland_Ordinary_Passive_06.Wasteland_Ordinary_Passive_06",
		bIsShowCD = false,
