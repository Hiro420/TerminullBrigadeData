local Ins_3030714 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconRuleC/Frames/NlRule_ptbd4_icon.NlRule_ptbd4_icon",
	InscriptionDataAry = 
	{
		{
			GenericModifyLevelId = "3030714",
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconRuleC/Frames/NlRule_ptbd4_icon.NlRule_ptbd4_icon",
		bIsShowCD = false,
