local Ins_3060711 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconRuleA/Frames/wealthRule_ptbd1_icon.wealthRule_ptbd1_icon",
	InscriptionDataAry = 
	{
		{
			GenericModifyLevelId = "3060711",
			bIsShowGenericModifyLevelDescInUI = false,
			ModifyLevelDescShowType = 0,
			bIsShowHelpInUI = false,
			bUseGenericModifyLevelData = false,
			Desc = "当造成任意伤害时基于货币数量提升伤害",
		},
	},
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconRuleA/Frames/wealthRule_ptbd1_icon.wealthRule_ptbd1_icon",
		bIsShowCD = false,
	...
	ModGenreRoutineRowName = "3060711",
}
return Ins_3060711