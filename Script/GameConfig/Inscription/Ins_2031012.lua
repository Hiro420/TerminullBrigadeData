local Ins_2031012 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconOneoutothree/Frames/Bat_SkilNAX_weapon.Bat_SkilNAX_weapon",
	InscriptionDataAry = 
	{
		{
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconOneoutothree/Frames/Bat_SkilNAX_weapon.Bat_SkilNAX_weapon",
		bIsShowCD = false,
