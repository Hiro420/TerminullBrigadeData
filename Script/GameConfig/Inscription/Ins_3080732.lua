local Ins_3080732 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconPurview/Frames/Wasteland_Ordinary_Passive_02.Wasteland_Ordinary_Passive_02",
	InscriptionDataAry = 
	{
		{
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Atlas_DT/IconPurview/Frames/Wasteland_Ordinary_Passive_02.Wasteland_Ordinary_Passive_02",
		bIsShowCD = false,
