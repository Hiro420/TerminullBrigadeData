local Ins_3080610 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconPurview/Frames/Wasteland_Shoot_Slot.Wasteland_Shoot_Slot",
	InscriptionDataAry = 
	{
		{
			GenericModifyLevelId = "3080610",
			bIsShowGenericModifyLevelDescInUI = true,
			ModifyLevelDescShowType = 1,
			bIsShowHelpInUI = false,
			bUseGenericModifyLevelData = false,
			Desc = "造成武器伤害时伤害中心为CD伤害好了后的首次武器伤害伤害的敌人，使得范围0下的敌人受到-1伤害",
		},
	},
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Atlas_DT/IconPurview/Frames/Wasteland_Shoot_Slot.Wasteland_Shoot_Slot",
		bIsShowCD = true,
