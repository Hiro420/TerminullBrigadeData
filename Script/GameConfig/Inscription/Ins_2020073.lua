local Ins_2020073 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_Alpha/A_DT/ICON/MOZU_SK/Frames/Module_taluoso_24_png.Module_taluoso_24_png",
	InscriptionDataAry = 
	{
		{
			...
			Desc = "造成火元素异常后减少GameEffect.Ability.RecoveryMoveSkillCount2秒冷却",
		},
	},
