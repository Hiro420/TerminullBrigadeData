local Ins_3070241 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconRuleB/Frames/CjRule_ESkill_icon.CjRule_ESkill_icon",
	InscriptionDataAry = 
	{
		{
			GenericModifyLevelId = "3070240",
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconRuleB/Frames/CjRule_ESkill_icon.CjRule_ESkill_icon",
		bIsShowCD = false,
