local Ins_3000719 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconRuleA/Frames/SecureRule_Ice_icon.SecureRule_Ice_icon",
	InscriptionDataAry = 
	{
		{
			...
			Desc = "所有技能伤害提升{DamageAddPercentage}%",
		},
		{
			GenericModifyLevelId = "",
			bIsShowGenericModifyLevelDescInUI = true,
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconRuleA/Frames/SecureRule_ptbd6_icon.SecureRule_ptbd6_icon",
		bIsShowCD = false,
