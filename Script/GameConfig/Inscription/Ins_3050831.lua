local Ins_3050831 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconRuleB/Frames/JzRule_Rhythm_icon.JzRule_Rhythm_icon",
	InscriptionDataAry = 
	{
		{
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconRuleB/Frames/JzRule_ptbd7_icon.JzRule_ptbd7_icon",
		bIsShowCD = false,
