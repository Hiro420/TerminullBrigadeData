local Ins_3020724 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconRuleC/Frames/XyRule_ptbd4_icon.XyRule_ptbd4_icon",
	InscriptionDataAry = 
	{
		{
			GenericModifyLevelId = "3020724",
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconRuleC/Frames/XyRule_ptbd4_icon.XyRule_ptbd4_icon",
		bIsShowCD = false,
