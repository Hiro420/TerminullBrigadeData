local Ins_3080420 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconPurview/Frames/Wasteland_Reload_Slot.Wasteland_Reload_Slot",
	InscriptionDataAry = 
	{
		{
			GenericModifyLevelId = "3080420",
		...
		},
		{
			...
			bIsShowHelpInUI = false,
			bUseGenericModifyLevelData = false,
			Desc = "当BUFF{RemoveBuffID}移除自身有308,002BUFF时移除未命名BUFF",
		},
	},
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Atlas_DT/IconPurview/Frames/Wasteland_Reload_Slot.Wasteland_Reload_Slot",
		bIsShowCD = true,
