local Ins_6020601 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_Alpha/A_DT/ICON/MOZU_SK/Frames/Module_taluoso_19_png.Module_taluoso_19_png",
	InscriptionDataAry = 
	{
		{
			...
			Desc = "造成角色2技能后减少GameEffect.Ability.RecoverySkillCountSkillQ2秒冷却",
		},
	},
