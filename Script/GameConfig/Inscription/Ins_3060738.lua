local Ins_3060738 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconRuleA/Frames/wealthRule_Present_icon.wealthRule_Present_icon",
	InscriptionDataAry = 
	{
		{
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconRuleA/Frames/wealthRule_ptbd6_icon.wealthRule_ptbd6_icon",
		bIsShowCD = false,
