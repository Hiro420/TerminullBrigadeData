local Ins_2010012 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_Alpha/A_DT/ICON/MOZU_SK/Frames/Module_xiaoqingICON_06_png.Module_xiaoqingICON_06_png",
	InscriptionDataAry = 
	{
		{
	...
	ModAdditionalNoteMap = 
	{
		[20101] = 
		{
			ModAdditionalNote = NSLOCTEXT("","A9F955544700656A770E4E931FDC94C3","匕首命中敌人后，将发射复数枚自动追踪的匕首追踪附近的敌人；优先锁定更多的敌人而非单一敌人"),
			ModNoteTitle = NSLOCTEXT("","077804004B4809C31D3338B75E28A139","分裂"),
		},
	},
