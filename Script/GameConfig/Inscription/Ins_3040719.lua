local Ins_3040719 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconRuleB/Frames/DwRule_Blessing_icon.DwRule_Blessing_icon",
	InscriptionDataAry = 
	{
		{
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconRuleB/Frames/DwRule_ptbd6_icon.DwRule_ptbd6_icon",
		bIsShowCD = false,
