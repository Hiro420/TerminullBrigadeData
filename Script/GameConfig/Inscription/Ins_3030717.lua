local Ins_3030717 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconRuleC/Frames/NlRule_ptbd7_icon.NlRule_ptbd7_icon",
	InscriptionDataAry = 
	{
		{
			GenericModifyLevelId = "3030717",
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconRuleC/Frames/NlRule_ptbd7_icon.NlRule_ptbd7_icon",
		bIsShowCD = false,
