local Ins_3060725 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconRuleA/Frames/wealthRule_ptbd5_icon.wealthRule_ptbd5_icon",
	InscriptionDataAry = 
	{
		{
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconRuleA/Frames/wealthRule_ptbd5_icon.wealthRule_ptbd5_icon",
		bIsShowCD = false,
