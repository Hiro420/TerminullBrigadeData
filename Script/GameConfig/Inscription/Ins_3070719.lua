local Ins_3070719 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconRuleB/Frames/CjRule_ptbd8_icon.CjRule_ptbd8_icon",
	InscriptionDataAry = 
	{
		{
			GenericModifyLevelId = "403010",
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconRuleB/Frames/CjRule_ptbd6_icon.CjRule_ptbd6_icon",
		bIsShowCD = false,
