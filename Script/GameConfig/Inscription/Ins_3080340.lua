local Ins_3080340 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconPurview/Frames/Wasteland_C_Slot.Wasteland_C_Slot",
	InscriptionDataAry = 
	{
		{
			GenericModifyLevelId = "3080340",
		...
		},
		{
			...
			bIsShowHelpInUI = false,
			bUseGenericModifyLevelData = false,
			Desc = "当BUFF{RemoveBuffID}移除自身有308,001BUFF时移除未命名BUFF",
		},
	},
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Atlas_DT/IconPurview/Frames/Wasteland_C_Slot.Wasteland_C_Slot",
		bIsShowCD = true,
