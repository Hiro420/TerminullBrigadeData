local Ins_3020737 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconRuleC/Frames/XyRule_ptbd7_icon.XyRule_ptbd7_icon",
	InscriptionDataAry = 
	{
		{
			GenericModifyLevelId = "3020737",
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconRuleC/Frames/XyRule_ptbd7_icon.XyRule_ptbd7_icon",
		bIsShowCD = false,
