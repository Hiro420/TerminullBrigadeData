local Ins_3030715 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_DT/IconRuleC/Frames/NlRule_ptbd5_icon.NlRule_ptbd5_icon",
	InscriptionDataAry = 
	{
		{
			GenericModifyLevelId = "3030715",
	...
	InscriptionCDData = 
	{
		CDName = nil,
		CDDesc = nil,
		CDIcon = "/Game/Rouge/UI/Sprite/IconRuleC/Frames/NlRule_ptbd5_icon.NlRule_ptbd5_icon",
		bIsShowCD = false,
