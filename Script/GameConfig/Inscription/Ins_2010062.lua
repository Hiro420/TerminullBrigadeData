local Ins_2010062 = 
{
	...
	Rarity = 0,
	Icon = "/Game/Rouge/UI/Atlas_Alpha/A_DT/ICON/MOZU_SK/Frames/Module_xiaoqingICON_04_png.Module_xiaoqingICON_04_png",
	InscriptionDataAry = 
	{
		{
	...
	ModAdditionalNoteMap = 
	{
		[20101] = 
		{
			ModAdditionalNote = NSLOCTEXT("","73A680B44E54F969FF8305BEDBDE8361","匕首命中敌人后，将发射复数枚自动追踪的匕首追踪附近的敌人；优先锁定更多的敌人而非单一敌人"),
			ModNoteTitle = NSLOCTEXT("","807C249C4D89720A8F122DB2FB3551B8","分裂"),
		},
	},
