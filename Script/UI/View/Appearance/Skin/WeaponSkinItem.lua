...
function WeaponSkinItem:InitWeaponSkinItem(WeaponSkinInfo, EquipedSkinId, HeroId, SkinID, TopView)
  ...
  UpdateVisibility(self.URGImageEquiped, WeaponSkinInfo.WeaponSkinTb.SkinID == EquipedSkinId)
  UpdateVisibility(self.Image_jiao, WeaponSkinInfo.WeaponSkinTb.SkinID == EquipedSkinId)
