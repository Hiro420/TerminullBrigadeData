local WBP_ExtraDescItemsPanel_C = UnLua.Class()
function WBP_ExtraDescItemsPanel_C:UpdateInscriptionAdditions(InscriptionIdArray)
...
return WBP_ExtraDescItemsPanel_C
